# 🔐 CLAY 远程管理系统
一款基于 Python 和 WebSocket 技术的轻量级远程控制工具，支持多设备集中管理，通过浏览器即可实现跨平台远程操作。
# ✨ 核心功能
💻 远程终端控制：执行命令并实时获取输出，支持目录切换与环境变量
🖥️ 屏幕监控：实时捕获屏幕内容，可调整画质与刷新频率
📹 摄像头访问：远程调用设备摄像头，支持即时画面捕获
🔒 系统操作：远程锁屏、关机等核心系统控制
📱 多客户端管理：同时管理多台设备，支持设备分组与状态监控
🔄 持久化连接：自动重连机制，确保长期稳定控制
